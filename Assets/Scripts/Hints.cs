...
public class Hints : MonoBehaviour
{
    ...
    private string frase2 = "Trees, bushes, rivers, mountains can't be collected.\n\nResources are hidden all over the planet.\n\nHidden in this level are: Wood-2, Tools-4, Metal-2, Rocks-4";
    ...
    private string frase4 = "To control the ship, use the keyboard buttons \"Forward\", \"Backward\", \"Left\", \"Right\".\n\nTo switch control from the ship to the drone(and back), you need to press the Space button by keyboard.\n\nTo control the Drone, click on the left mouse button.To turn left or right, move the mouse in the desired direction.";
    ...
    void Update()
    {
        ...
        else if (!Change_camera.camera_space)
        {
            text_timer.enabled = false;
            text_portal.enabled = false;
            text_tools.enabled = false;
